...
import { ArrowLeft, ChevronRight, Loader2, Mail } from "lucide-react";
...
const ConnectEmailDialog = ({ open, onOpenChange }: Props) => {
  ...
  const [view, setView] = useState<"providers" | "smtp">("providers");

  const handleOpenChange = (v: boolean) => {
    if (!v) setView("providers");
    onOpenChange(v);
  };
          ...
          <div className="space-y-3 pt-2">
            ...
            >
              ...
              <span className="flex-1 font-medium">
                {t("emailAccounts.connectGoogle", "Connect with Google")}
              </span>
            ...
            >
              ...
              <span className="flex-1 font-medium">
                {t("emailAccounts.connectMicrosoft", "Connect with Microsoft")}
              </span>
              <ChevronRight className="h-5 w-5 text-muted-foreground shrink-0" />
            </button>
            ...
            >
              ...
              <span className="flex-1">
                <span className="block font-medium">
                  {t("emailAccounts.connectImap", "Connect with IMAP / SMTP")}
                </span>
                <span className="block text-xs text-muted-foreground mt-0.5">
                  {t("emailAccounts.imapDescription", "Use any email provider")}
                </span>
              </span>
              <ChevronRight className="h-5 w-5 text-muted-foreground shrink-0" />
            </button>
