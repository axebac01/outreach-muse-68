delete from sequence_leads where id='39eb58b8-8938-4b68-aa76-25c784f9e07e';
update sequence_leads set status='pending', current_step=0 where sequence_id='4ed83fca-78ef-48eb-ab3d-021ef2e74843';
...
update sequence_leads set status='active' where sequence_id='4ed83fca-78ef-48eb-ab3d-021ef2e74843';
update sequences set status='active' where id='4ed83fca-78ef-48eb-ab3d-021ef2e74843';